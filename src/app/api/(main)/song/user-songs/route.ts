...
export async function GET(req: NextRequest) {
  ...
  console.log("[user-songs][DEBUG] Request headers:", Object.fromEntries(req.headers.entries()));
  try {
  ...
  console.log("[user-songs][DEBUG] Query params:", {
    userId, page, limit, search, level, key, author, sortBy, sortOrder
  });
  ...
  if (userId) {
    ...
    console.log("[user-songs][DEBUG] lessonSongs result:", lessonSongs, lessonSongsError);
    if (lessonSongsError) {
      return NextResponse.json(
