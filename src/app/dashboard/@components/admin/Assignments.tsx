  ...
  return (
    <div className="bg-white rounded-xl shadow p-5 mt-2">
        ...
        {assignments.map((a) => (
          <li key={a.title} className="flex items-center gap-3 py-2">
            <div className="flex-1">
              ...
              <div className="text-xs text-gray-500">{a.student} • Due {a.due}</div>
            </div>
      ...
      <div className="text-right mt-2">
        <button className="text-blue-600 hover:underline text-sm font-semibold">View all assignments →</button>
      </div>
    </div>
  );
}; 