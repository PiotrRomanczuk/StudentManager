        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-20 px-6 lg:px-8 xl:grid-cols-5">
          ...
          >
            ...
            <p className="mt-6 text-lg/8 text-gray-600">
              This application was created by Piotr Romanczuk. Who created this application to help him with his work as a guitar teacher, and hopefully helps other teachers to manage their students better.
            </p>
          </motion.div>
